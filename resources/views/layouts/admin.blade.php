...
<div class="top_box">
    <div class="top_left">
        ...
        <ul>
            <li><a href="{{route('admin.home')}}" class="active">首页</a></li>
            <li><a href="#">管理页</a></li>
        </ul>
    </div>
    <div class="top_right">
        <ul>
            <li>{{$sitename2}} 管理员：{{session('admin.name')}}</li>
            <li><a href="{{route('admin.user.change_password')}}">修改密码</a></li>
...
<div class="main_box">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{route('admin.home')}}">首页</a>@yield('breadcrumbs')
    </div>
    <!--面包屑导航 结束-->
    @yield('content')
</div>
